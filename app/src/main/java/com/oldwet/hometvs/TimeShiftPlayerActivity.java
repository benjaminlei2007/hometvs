...
public class TimeShiftPlayerActivity extends AppCompatActivity
...
//    private final ArrayList<FrameworkMediaDrm> mediaDrms;
    ...
    public TimeShiftPlayerActivity() {
//        mediaDrms = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerView.setErrorMessageProvider(new TimeShiftPlayerActivity.PlayerErrorMessageProvider());
...
//            releaseMediaDrms();
            ...
            player =
                    new SimpleExoPlayer.Builder(/* context= */ this, renderersFactory)
                            ...
                            .build();
            player.addListener(new TimeShiftPlayerActivity.PlayerEventListener());
