...
//        mediaDrms = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerView.setErrorMessageProvider(new LivePlayerActivity.PlayerErrorMessageProvider());
        ...
        //Fragment
        PlayerChannelsFragment fragment=PlayerChannelsFragment.newInstance("","");
        getSupportFragmentManager().beginTransaction().add(R.id.channel_frame, fragment).commit();
...
//            releaseMediaDrms();
            ...
            player =
                    new SimpleExoPlayer.Builder(/* context= */ this, renderersFactory)
                            ...
                            .build();
            player.addListener(new LivePlayerActivity.PlayerEventListener());
